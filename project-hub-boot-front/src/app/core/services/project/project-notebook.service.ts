import { ProjectNotebook, ProjectNotebookCreate, ProjectNotebookSimple } from '../../interfaces/project/project-notebook.interface';
import { ProjectSimple } from '../../interfaces/project/project.interface';
